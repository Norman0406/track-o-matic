...
// This file contains a mapping of timezones to their POSIX-style timezone strings.
// The timezone strings are based on the IANA time zone database format.
// https://raw.githubusercontent.com/nayarsystems/posix_tz_db/refs/heads/master/zones.csv

const std::unordered_map<std::string_view, std::string> iana_to_posix_timezone_map = {
    {"Africa/Abidjan", "GMT0"},
    {"Africa/Accra", "GMT0"},
